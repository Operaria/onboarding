    ...
    preguntas: [
      {
        ...
        numero: "1.1",
        tipo: "textarea",
        label: "¿De qué te vas a encargar en Operaria?",
        placeholder: "Cuéntame tu rol como lo dirías tú, sin formalismos.",
      },
      {
        id: "semana",
        numero: "1.2",
      ...
      },
      {
        ...
        placeholder: "tucorreo@operaria.cl",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    preguntas: [
      ...
      },
      {
        ...
        numero: "4.3",
        tipo: "textarea",
        label: "¿Cómo quieres que trate al resto del equipo?",
    ...
    preguntas: [
      {
        ...
        numero: "7.1",
        tipo: "textarea",
        label: "Como en la familia: ¿qué personalidad o temperatura te gustaría que tuviera Cindy?",
        hint: "Para que sea familia, no herramienta.",
      },
      {
        id: "exito",
        numero: "7.2",
